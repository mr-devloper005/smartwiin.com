export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'smartwiin',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Smartwiin',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'smartwiin.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://smartwiin.com',
